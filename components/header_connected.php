  ...
  <div class="container justify-content-center">
    ...
    <div class="collapse navbar-collapse justify-content-center" id="navbarButtonsExample">
      ...
      <ul class="navbar-nav me-auto mb-4 mb-lg-0 ">
        ...
        <li class="nav-item">
          <a class="nav-link" href="http://localhost/dev/pages/franciscoassis/Pagina_Cripto/pagina_cripto.php">Crypto</a>
        </li>
        <li class="nav-item">
      ...
      <div class="d-flex align-items-center ms-auto mb-2 mb-lg-0">
        <a type="button" class="btn btn-warning px-3 me-2" href="http://localhost/dev/pages/rubenteixeira/dashboard/">
          Painel
        </a>
        <a type="button" class="btn btn-primary me-3"  href="../../../components/logout.php">
          Sair
        </a>
      </div>
    </div>
